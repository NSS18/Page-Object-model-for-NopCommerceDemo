...
public class HomePage extends Utils {
    ...
    //Locator for book link
    private By _bookLink2=By.xpath("//div[6]/div[2]/ul[1]/li[5]/a[contains(text(),\"Books \")]");
    private By _backToHomepage=By.xpath("//div[@class=\"header-logo\"]/a/img");
    ...
    {
        scrollAndClick(_backToHomepage);
    }
    ...
    public void clickOnLogin()
    {
        ...
        scrollAndClick(_loginLink);
        timeDelay(2);
    }
    //To click on books link
    public void clickBooks()
    {
        scrollAndClick(_bookLink2);
    }
    ...
    {
     //waitForClickable(_bookLink2,30);
        timeDelay(3);
     clickOnElement(_bookLink2);
     timeDelay(2);
    }
